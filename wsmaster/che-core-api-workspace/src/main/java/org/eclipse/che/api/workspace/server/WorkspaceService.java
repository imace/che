...
public class WorkspaceService extends Service {
    ...
    public WorkspaceDto startById(@ApiParam("The workspace id")
                                  ...
                                  @QueryParam("restore")
                                  Boolean isRestore) throws ServerException,
                                                            BadRequestException,
                                                            NotFoundException,
                                                            ForbiddenException,
                                                            ConflictException {

        return linksInjector.injectLinks(asDto(workspaceManager.startWorkspace(workspaceId, envName, accountId, isRestore)),
                                         getServiceContext());
    }
