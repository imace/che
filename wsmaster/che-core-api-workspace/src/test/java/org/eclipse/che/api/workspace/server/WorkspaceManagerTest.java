...
public class WorkspaceManagerTest {
    ...
    @Test
    public void shouldRecoverWorkspaceWhenIsRecoverParameterIsNullAndAutoRestoreAttributeIsSetAndSnapshotExists() throws Exception {
        final WorkspaceImpl workspace = workspaceManager.createWorkspace(createConfig(), "user123", "account");
    ...
    @Test
    public void shouldRecoverWorkspaceWhenIsRecoverParameterIsTrueAndSnapshotExists() throws Exception {
        final WorkspaceImpl workspace = workspaceManager.createWorkspace(createConfig(), "user123", "account");
        when(machineManager.getSnapshots(any(), any())).thenReturn(singletonList(mock(SnapshotImpl.class)));
        when(workspaceDao.get(workspace.getId())).thenReturn(workspace);
        when(runtimes.get(any())).thenThrow(new NotFoundException(""));
    ...
    @Test
    public void shouldNotRecoverWorkspaceWhenIsRecoverParameterIsNullAndAutoRestoreAttributesIsSetButSnapshotDoesNotExist() throws Exception {
        final WorkspaceImpl workspace = workspaceManager.createWorkspace(createConfig(), "user123", "account");
        workspace.getAttributes().put(AUTO_RESTORE_FROM_SNAPSHOT, "true");
        when(workspaceDao.get(workspace.getId())).thenReturn(workspace);
        when(runtimes.get(any())).thenThrow(new NotFoundException(""));
    ...
    @Test
    public void shouldNotRecoverWorkspaceWhenIsRecoverParameterIsTrueButSnapshotDoesNotExist() throws Exception {
        final WorkspaceImpl workspace = workspaceManager.createWorkspace(createConfig(), "user123", "account");
        when(workspaceDao.get(workspace.getId())).thenReturn(workspace);
        when(runtimes.get(any())).thenThrow(new NotFoundException(""));
    ...
    @Test
    public void shouldNotRecoverWorkspaceWhenIsRecoverParameterIsFalseAndAutoRestoreAttributeIsSetAndSnapshotExists() throws Exception {
        final WorkspaceImpl workspace = workspaceManager.createWorkspace(createConfig(), "user123", "account");
        workspace.getAttributes().put(AUTO_RESTORE_FROM_SNAPSHOT, "true");
        when(machineManager.getSnapshots(any(), any())).thenReturn(singletonList(mock(SnapshotImpl.class)));
        when(workspaceDao.get(workspace.getId())).thenReturn(workspace);
